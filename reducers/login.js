...
export const createUser = (email, uid, dispatch) => {
  let monsters = {0: {name:"I need name",type:"grayMonster",size:1,location:"",latitude:40.8165683, longitude:-73.9472318},1:{name:"name me",type:"redMonster",size:1,location:"",latitude:40.8165683, longitude:-73.9472318},2:{name:"no name yet",type:"greenMonster",size:1,location:"",latitude:40.8165683, longitude:-73.9472318}}
