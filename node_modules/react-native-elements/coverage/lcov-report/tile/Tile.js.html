...
<html lang="en">
<head>
    <title>Code coverage report for tile/Tile.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">tile</a> Tile.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!width) {
    width = Dimensions.get('window').width;
  }
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!height) {
    height = width * 0.8;
  }
&nbsp;
