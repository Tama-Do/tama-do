...
CardStack.propTypes = (_CardStack$propTypes = {
...
}, _defineProperty(_CardStack$propTypes, 'navigation', babelPluginFlowReactPropTypes_proptype_NavigationScreenProp), _defineProperty(_CardStack$propTypes, 'position', require('prop-types').any.isRequired), _defineProperty(_CardStack$propTypes, 'progress', require('prop-types').any.isRequired), _defineProperty(_CardStack$propTypes, 'scenes', require('prop-types').arrayOf(babelPluginFlowReactPropTypes_proptype_NavigationScene).isRequired), _defineProperty(_CardStack$propTypes, 'scene', babelPluginFlowReactPropTypes_proptype_NavigationScene), _defineProperty(_CardStack$propTypes, 'index', require('prop-types').number.isRequired), _CardStack$propTypes);
