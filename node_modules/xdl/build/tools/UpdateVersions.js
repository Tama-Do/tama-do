...
let updateSdkVersionsAsync = exports.updateSdkVersionsAsync = (() => {
  var _ref = _asyncToGenerator(function* (sdkVersion, reactNativeTag, facebookRNVersion) {
  ...
  return function updateSdkVersionsAsync(_x, _x2, _x3) {
...
let updateIOSSimulatorBuild = exports.updateIOSSimulatorBuild = (() => {
  var _ref2 = _asyncToGenerator(function* (s3Client, pathToApp, appVersion) {
    ...
    yield s3Client.promise.putObject({
  ...
  return function updateIOSSimulatorBuild(_x4, _x5, _x6) {
...
let updateAndroidApk = exports.updateAndroidApk = (() => {
  ...
  return function updateAndroidApk(_x7, _x8, _x9) {
