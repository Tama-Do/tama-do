...
let publishAsync = exports.publishAsync = (() => {
  var _ref7 = _asyncToGenerator(function* (projectRoot, options = {}) {
    ...
    let {
      iosSourceMap,
      androidSourceMap
    } = yield _maybeBuildSourceMapsAsync(projectRoot, exp, {
      force: validPostPublishHooks.length
    });

    let response = yield _uploadArtifactsAsync({
      exp,
      iosBundle,
      androidBundle,
      options
...
let _uploadArtifactsAsync = (() => {
  var _ref8 = _asyncToGenerator(function* ({
    ...
    let response = yield (_Api || _load_Api()).default.callMethodAsync('publish', [options], 'put', null, {
      formData
    });
  ...
  return function _uploadArtifactsAsync(_x13) {
...
let _validatePackagerReadyAsync = (() => {
  ...
  return function _validatePackagerReadyAsync(_x14) {
...
let _getPublishExpConfigAsync = (() => {
  ...
  return function _getPublishExpConfigAsync(_x15, _x16) {
...
let _buildPublishBundlesAsync = (() => {
  ...
  return function _buildPublishBundlesAsync(_x17) {
...
let _maybeBuildSourceMapsAsync = (() => {
  var _ref12 = _asyncToGenerator(function* (projectRoot, exp, options = {}) {
    if (!options.force) {
  ...
  return function _maybeBuildSourceMapsAsync(_x18, _x19) {
    return _ref12.apply(this, arguments);
  };
})();

let _fetchAndUploadAssetsAsync = (() => {
  var _ref13 = _asyncToGenerator(function* (projectRoot, exp) {
    ...
    yield _resolveManifestAssets(projectRoot, exp, (() => {
      var _ref14 = _asyncToGenerator(function* (assetPath) {
  ...
  return function _fetchAndUploadAssetsAsync(_x20, _x21) {
...
let _maybeWriteArtifactsToDiskAsync = (() => {
  var _ref15 = _asyncToGenerator(function* ({
    ...
    if (exp.android && exp.android.publishSourceMapPath) {
      yield _fs.default.promise.writeFile(_path.default.resolve(projectRoot, exp.android.publishSourceMapPath), androidSourceMap);
    }

    if (exp.ios && exp.ios.publishSourceMapPath) {
      yield _fs.default.promise.writeFile(_path.default.resolve(projectRoot, exp.ios.publishSourceMapPath), iosSourceMap);
    }
  });

  return function _maybeWriteArtifactsToDiskAsync(_x23) {
    return _ref15.apply(this, arguments);
  };
})();

let _handleKernelPublishedAsync = (() => {
  var _ref16 = _asyncToGenerator(function* ({ projectRoot, user, exp, url }) {
  ...
  return function _handleKernelPublishedAsync(_x24) {
...
let uploadAssetsAsync = (() => {
  var _ref17 = _asyncToGenerator(function* (projectRoot, assets) {
    ...
    yield Promise.all((_lodash || _load_lodash()).default.chunk(missing, 5).map((() => {
      var _ref18 = _asyncToGenerator(function* (keys) {
        let formData = {};
  ...
  return function uploadAssetsAsync(_x25, _x26) {
...
let buildAsync = exports.buildAsync = (() => {
  ...
  return function buildAsync(_x28) {
    return _ref19.apply(this, arguments);
  };
})();

let _waitForRunningAsync = (() => {
  var _ref20 = _asyncToGenerator(function* (url) {
    try {
  ...
  return function _waitForRunningAsync(_x29) {
    return _ref20.apply(this, arguments);
  };
})();

let _restartWatchmanAsync = (() => {
  var _ref21 = _asyncToGenerator(function* (projectRoot) {
    try {
  ...
  return function _restartWatchmanAsync(_x30) {
    return _ref21.apply(this, arguments);
  };
})();

let startReactNativeServerAsync = exports.startReactNativeServerAsync = (() => {
  var _ref22 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    yield (_User || _load_User()).default.ensureLoggedInAsync();
    _assertValidProjectRoot(projectRoot);
  ...
  return function startReactNativeServerAsync(_x31) {
...
let stopReactNativeServerAsync = exports.stopReactNativeServerAsync = (() => {
  ...
  return function stopReactNativeServerAsync(_x33) {
    return _ref24.apply(this, arguments);
  };
})();

let startExpoServerAsync = exports.startExpoServerAsync = (() => {
  var _ref25 = _asyncToGenerator(function* (projectRoot) {
    yield (_User || _load_User()).default.ensureLoggedInAsync();
    _assertValidProjectRoot(projectRoot);
    ...
    let manifestHandler = (() => {
      var _ref26 = _asyncToGenerator(function* (req, res) {
        try {
          ...
          yield _resolveManifestAssets(projectRoot, manifest, (() => {
            var _ref27 = _asyncToGenerator(function* (path) {
      ...
      return function manifestHandler(_x35, _x36) {
  ...
  return function startExpoServerAsync(_x34) {
...
let stopExpoServerAsync = exports.stopExpoServerAsync = (() => {
  ...
  return function stopExpoServerAsync(_x42) {
    return _ref30.apply(this, arguments);
  };
})();

let _connectToNgrokAsync = (() => {
  var _ref31 = _asyncToGenerator(function* (projectRoot, args, hostnameAsync, ngrokPid, attempts = 0) {
    try {
  ...
  return function _connectToNgrokAsync(_x43, _x44, _x45, _x46) {
    return _ref31.apply(this, arguments);
  };
})();

let startTunnelsAsync = exports.startTunnelsAsync = (() => {
  var _ref32 = _asyncToGenerator(function* (projectRoot) {
    const user = yield (_User || _load_User()).default.ensureLoggedInAsync();
    if (!user) {
  ...
  return function startTunnelsAsync(_x47) {
...
let stopTunnelsAsync = exports.stopTunnelsAsync = (() => {
  ...
  return function stopTunnelsAsync(_x48) {
    return _ref35.apply(this, arguments);
  };
})();

let setOptionsAsync = exports.setOptionsAsync = (() => {
  var _ref36 = _asyncToGenerator(function* (projectRoot, options) {
    yield (_User || _load_User()).default.ensureLoggedInAsync();
  ...
  return function setOptionsAsync(_x49, _x50) {
    return _ref36.apply(this, arguments);
  };
})();

let getUrlAsync = exports.getUrlAsync = (() => {
  var _ref37 = _asyncToGenerator(function* (projectRoot, options = {}) {
    yield (_User || _load_User()).default.ensureLoggedInAsync();
    _assertValidProjectRoot(projectRoot);
    return yield (_UrlUtils || _load_UrlUtils()).constructManifestUrlAsync(projectRoot, options);
  });

  return function getUrlAsync(_x51) {
    return _ref37.apply(this, arguments);
  };
})();

let startAsync = exports.startAsync = (() => {
  var _ref38 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    yield (_User || _load_User()).default.ensureLoggedInAsync();
    _assertValidProjectRoot(projectRoot);
  ...
  return function startAsync(_x52) {
...
let _stopInternalAsync = (() => {
  ...
  return function _stopInternalAsync(_x53) {
    return _ref39.apply(this, arguments);
  };
})();

let stopAsync = exports.stopAsync = (() => {
  var _ref40 = _asyncToGenerator(function* (projectDir) {
    ...
    if (result === 'stopFailed') {
      ...
      const {
        packagerPid,
        ngrokPid
      } = yield (_ProjectSettings || _load_ProjectSettings()).readPackagerInfoAsync(projectDir);
      if (packagerPid) {
        try {
  ...
  return function stopAsync(_x54) {
