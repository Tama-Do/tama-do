...
let constructUrlWithExtensionAsync = exports.constructUrlWithExtensionAsync = (() => {
  var _ref3 = _asyncToGenerator(function* (projectRoot, entryPoint, ext, requestHostname) {
  ...
  return function constructUrlWithExtensionAsync(_x7, _x8, _x9, _x10) {
    return _ref3.apply(this, arguments);
  };
})();

let constructPublishUrlAsync = exports.constructPublishUrlAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (projectRoot, entryPoint, requestHostname) {
    return yield constructUrlWithExtensionAsync(projectRoot, entryPoint, 'bundle', requestHostname);
  });

  return function constructPublishUrlAsync(_x11, _x12, _x13) {
...
let constructSourceMapUrlAsync = exports.constructSourceMapUrlAsync = (() => {
  ...
  return function constructSourceMapUrlAsync(_x14, _x15, _x16) {
...
let constructAssetsUrlAsync = exports.constructAssetsUrlAsync = (() => {
  ...
  return function constructAssetsUrlAsync(_x17, _x18, _x19) {
    return _ref6.apply(this, arguments);
  };
})();

let constructDebuggerHostAsync = exports.constructDebuggerHostAsync = (() => {
  var _ref7 = _asyncToGenerator(function* (projectRoot, requestHostname) {
    return constructUrlAsync(projectRoot, {
      urlType: 'no-protocol'
    }, true, requestHostname);
  });

  return function constructDebuggerHostAsync(_x20, _x21) {
    return _ref7.apply(this, arguments);
  };
})();

let constructBundleQueryParamsAsync = exports.constructBundleQueryParamsAsync = (() => {
  var _ref8 = _asyncToGenerator(function* (projectRoot, opts) {
  ...
  return function constructBundleQueryParamsAsync(_x22, _x23) {
    return _ref8.apply(this, arguments);
  };
})();

let constructUrlAsync = exports.constructUrlAsync = (() => {
  var _ref9 = _asyncToGenerator(function* (projectRoot, opts, isPackager, requestHostname) {
    if (opts) {
      ...
      try {
        yield (_joi || _load_joi()).default.promise.validate(opts, schema);
      } catch (e) {
  ...
  return function constructUrlAsync(_x24, _x25, _x26, _x27) {
